          ...
          <div ref={containerRef} className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
            {filtered.map((item, i) => (
              <div
                ...
                className={[
                  "portfolio-item relative overflow-hidden rounded-2xl group cursor-pointer",
        ...
        <div className="mt-14 flex items-center justify-center">
          <div className="flex items-center gap-6 px-8 py-5 glass-light rounded-2xl border border-gray-200">
            <p className="font-sans text-sm text-gray-500">
              ...
              <strong className="text-charcoal font-semibold">250+ completed projects</strong>.
            </p>
            <Link
              to="/portfolio"
